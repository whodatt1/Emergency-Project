...
public class EmgcRltmResponseDto {
	...
	public static class Item {
		...
		private String phpid; // (구) 기관코드
		private String hvidate; // 입력일시
		private Integer hvec; // 응급실 일반 병상 인원
		private Integer hvoc; // [기타] 수술실 인원
		private Integer hvcc; // [중환자실] 신경과 인원
		private Integer hvncc; // [중환자실] 신생아 인원
		private Integer hvccc; // [중환자실] 흉부외과 인원
		private Integer hvicc; // [중환자실] 일반 인원
		private Integer hvgc; // [입원실] 일반 인원
		private String hvdnm; // 당직의
		private String hvctayn; // CT 가용 여부
		private String hvmriayn; // MRI 가용 여부
		private String hvangioayn; // 혈관촬영기 가용 여부
		...
		private String hvamyn; // 구급차 가용 여부
		private String hv1; // 응급실 당직의 직통 연락처
		private Integer hv2; // [중환자실] 내과 인원
		private Integer hv3; // [중환자실] 외과 인원
		private Integer hv4; // 외과입원실 (정형외과) 인원
		private String hv5; // 신경과입원실
		private Integer hv6; // [중환자실] 신경외과 인원
		private String hv7; // 약물 중환자
		private Integer hv8; // [중환자실] 화상 인원
		private Integer hv9; // [중환자실] 외상 인원
		private String hv10; // VENTI(소아) 여부
		private String hv11; // 인큐베이터(보육기) 여부
		private String hv12; // 소아당직의 직통 연락처
		private Integer hv13; // 격리진료구역 음압격리병상
		private Integer hv14; // 격리진료구역 일반격리병상
		private Integer hv15; // 소아 음압 격리 병상
		private Integer hv16; // 소아 일반 격리 병상
		private Integer hv17; // [응급전용] 중환자실 음압격리 인원
		private Integer hv18; // [응급전용] 중환자실 일반격리 인원
		private Integer hv19; // [응급전용] 입원실 음압격리 인원
		private Integer hv21; // [응급전용] 입원실 일반격리 인원
		private Integer hv22; // 감염병 전담병상 중환자실 인원
		private Integer hv23; // 감염병 전담병상 중환자실 내 음압격리병상 인원
		private Integer hv24; // [감염] 중증 병상 인원
		private Integer hv25; // [감염] 준-중증 병상 인원
		private Integer hv26; // [감염] 중등증 병상 인원
		private Integer hv27; // 코호트 격리 인원
		private Integer hv28; // 소아 인원
		private Integer hv29; // 응급실 음압 격리 병상 인원
		private Integer hv30; // 응급실 일반 격리 병상 인원
		private Integer hv31; // [응급전용] 중환자실 인원
		private Integer hv32; // [중환자실] 소아 인원
		private Integer hv33; // [응급전용] 소아중환자실 인원
		private Integer hv34; // [중환자실] 심장내과 인원
		private Integer hv35; // [중환자실] 음압격리 인원
		private Integer hv36; // [응급전용] 입원실 인원
		private Integer hv37; // [응급전용] 소아입원실
		private Integer hv38; // [입원실] 외상전용 인원
		private Integer hv39; // [기타] 외상전용 수술실 인원
		private Integer hv40; // [입원실] 정신과 폐쇄병동 인원
		private Integer hv41; // [입원실] 음압격리 인원
		private String hv42; // [기타] 분만실
		private String hv43; // [기타] 화상전용처치실
		private Integer hv60; // 외상소생실 V4 추가
		private Integer hv61; // 외상환자진료구역 V4 추가
		private String dutyName; // 기관명
		private String dutyTel3;
		private Integer hvs01; // 일반_기준 인원
		private Integer hvs02; // 소아_기준 인원
		private Integer hvs03; // 응급실 음압 격리 병상_기준 인원
		private Integer hvs04; // 응급실 일반 격리 병상_기준 인원
		private Integer hvs05; // [응급전용] 중환자실_기준 인원
		private Integer hvs06; // [중환자실] 내과_기준 인원
		private Integer hvs07; // [중환자실] 외과_기준 인원
		private Integer hvs08; // [중환자실] 신생아_기준 인원
		private Integer hvs09; // [중환자실] 소아_기준 인원
		private Integer hvs10; // [응급전용] 소아중환자실_기준 인원
		private Integer hvs11; // [중환자실] 신경과_기준 인원
		private Integer hvs12; // [중환자실] 신경외과_기준 인원
		private Integer hvs13; // [중환자실] 화상_기준 인원
		private Integer hvs14; // [중환자실] 외상_기준 인원
		private Integer hvs15; // [중환자실] 심장내과_기준 인원
		private Integer hvs16; // [중환자실] 흉부외과_기준 인원
		private Integer hvs17; // [중환자실] 일반_기준 인원
		private Integer hvs18; // [중환자실] 음압격리_기준 인원
		private Integer hvs19; // [응급전용] 입원실_기준 인원
		private Integer hvs20; // [응급전용] 소아입원실_기준 인원
		private Integer hvs21; // [입원실] 외상전용_기준 인원
		private Integer hvs22; // [기타] 수술실_기준 인원
		private Integer hvs23; // [기타] 외상전용 수술실_기준 인원
		private Integer hvs24; // [입원실] 정신과 폐쇄병동_기준 인원
		private Integer hvs25; // [입원실] 음압격리_기준 인원
		private Integer hvs26; // [기타] 분만실_기준 인원
		private Integer hvs27; // CT_기준 인원
		private Integer hvs28; // MRI_기준 인원
		private Integer hvs29; // 혈관촬영기_기준 인원
		private Integer hvs30; // 인공호흡기 일반_기준 인원
		private Integer hvs31; // 인공호흡기 조산아_기준
		private Integer hvs32; // 인큐베이터_기준 인원
		private Integer hvs33; // CRRT_기준 인원
		private Integer hvs34; // ECMO_기준 인원
		private Integer hvs35; // 중심체온조절유도기_기준 인원
		private Integer hvs36; // [기타] 화상전용처치실_기준 인원
		private Integer hvs37; // 고압산소치료기_기준 인원
		private Integer hvs38; // [입원실] 일반_기준 인원
		private Integer hvs46; // 격리진료구역 음압격리_기준 인원
		private Integer hvs47; // 격리진료구역 일반격리_기준 인원
		private Integer hvs48; // 소아음압격리_기준 인원
		private Integer hvs49; // 소아일반격리_기준 인원
		private Integer hvs50; // [응급전용] 중환자실 음압격리_기준 인원
		private Integer hvs51; // [응급전용] 중환자실 일반격리_기준 인원
		private Integer hvs52; // [응급전용] 입원실 음압격리_기준 인원
		private Integer hvs53; // [응급전용] 입원실 일반격리_기준 인원
		private Integer hvs54; // 감염병 전담병상 중환자실_기준 인원
		private Integer hvs55; // 감염병 전담병상 중환자실 내 음압격리병상_기준 인원
		private Integer hvs56; // [감염] 중증 병상_기준 인원
		private Integer hvs57; // [감염] 준-중증 병상_기준 인원
		private Integer hvs58; // [감염] 중등증 병상_기준 인원
		private Integer hvs59; // 코호트 격리_기준 인원
		private Integer hvs60; // 외상소생실_기준 인원
		private Integer hvs61; // 외상환자진료구역_기준 인원
	}
